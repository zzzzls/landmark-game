...
description: Production-ready CSS motion patterns and tokens for UI panels, dialogs, tabs, feedback, loading states, and transitions. Supports transitions reveal, review, apply, and refine. Read only the relevant recipe and adapt it to the project design and reduced-motion requirements.
---
